...
function Build-CISMEx470($findings)
{
	#Actual Inspector Object that will be returned. All object values are required to be filled in.
	$inspectorobject = New-Object PSObject -Property @{
		ID			     = "CISMEx470"
		FindingName	     = "CIS MEx 4.7 - Ensure that DKIM is enabled for all Exchange Online Domains"
...
function Inspect-CISMEx470
{
	Try
	{
		...
		{
			$endobject = Build-CISMEx470($domains_without_dkim)
			Return $endobject
		}
